...
export function buildLinePlaneIntersectionPlan(questionText, sourceSummary = {}) {
  ...
  const sceneMoments = buildAnalyticMoments([
    { id: "observe", title: "Observe", prompt: "Here's the scene. Try rotating it. What do you notice about where the line meets the plane?", goal: "Find the point and direction that anchor the line in space.", focusTargets: ["line-main", "plane-main", "point-anchor"], visibleObjectIds: ["line-main", "plane-main", "point-anchor", "normal-guide"], visibleOverlayIds: ["analytic-axes", "line-direction-label", "plane-equation-label", "point-anchor-label"], cameraBookmarkId: "overview" },
    { id: "relate", title: "Relate", prompt: "Now look at the normal. The plane's normal tells you how the plane is oriented, while the line direction tells you how the line moves.", goal: "Connect the line direction to the plane normal before touching the algebra.", focusTargets: ["normal-guide", "plane-main"], visibleObjectIds: ["line-main", "plane-main", "point-anchor", "normal-guide"], visibleOverlayIds: ["analytic-axes", "line-direction-label", "plane-equation-label", "point-anchor-label", "normal-label", "normal-pointer"], cameraBookmarkId: "normal-view" },
...
export function buildLinePlaneAnglePlan(questionText, sourceSummary = {}) {
  ...
  const sceneMoments = buildAnalyticMoments([
    { id: "observe", title: "Observe", prompt: "Rotate the scene. The line direction and the plane normal are the two orientations that matter here.", goal: "Identify the line direction and the plane's normal.", focusTargets: ["line-main", "plane-main", "normal-guide"], visibleObjectIds: ["line-main", "plane-main", "normal-guide"], visibleOverlayIds: ["analytic-axes", "line-direction-label", "plane-equation-label"], cameraBookmarkId: "overview" },
    { id: "relate", title: "Relate", prompt: "The angle between a line and a plane is not measured directly from the plane's surface equation. Use the normal as the bridge.", goal: "Notice that the line-plane angle is complementary to the line-normal angle.", focusTargets: ["line-main", "normal-guide"], visibleObjectIds: ["line-main", "plane-main", "normal-guide"], visibleOverlayIds: ["analytic-axes", "line-direction-label", "plane-equation-label", "normal-label", "complement-pointer"], cameraBookmarkId: "normal-view" },
