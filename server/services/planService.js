...
const SOURCE_SUMMARY_PROMPT = `You are an expert spatial maths tutor that reads question text and optional worksheet diagrams.
...
function heuristicSourceSummary({ questionText = "", imageAsset = null }) {
...
async function interpretQuestionSource({ questionText = "", imageAsset = null }) {
...
function heuristicPlan(question, mode = "guided", sourceSummary = null) {
...
async function planFromNova({ questionText, mode, sceneSnapshot, sourceSummary }) {
